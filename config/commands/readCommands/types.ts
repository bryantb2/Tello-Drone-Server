...
export type ReadFlightDistanceTime = BaseCommand<readCommands.FLIGHT_DISTANCE_TIME>
...
export type ReadCommand =
    ReadHeight | ReadFlightDistanceTime | ReadSpeedInXDirection
    | ReadSpeedInYDirection | ReadSpeedInZDirection | ReadAcceleration
    | ReadAccelInXDirection | ReadAccelInYDirection | ReadAccelInZDirection
    | ReadTemp | ReadLowestTemp | ReadHighestTemp | ReadAttitude
    | ReadPitch | ReadRoll | ReadYaw | ReadBarometer | ReadBattery
    | ReadTime | ReadWifi | ReadSDKVersion | ReadSerialNumber
